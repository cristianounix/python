...
VALUES  (1, 'Stephen', 'King'), (2, 'Trudi', 'Canavan');
...
INSERT INTO `books` (`id`, `author_id`, `title`, `original_language`, `isbn`) 
VALUES  (1, 1, 'The Shining', 'EN', '978-0307743657'),
        (2, 1, 'The Dark Tower: The Gunslinger', 'EN', '978-0-937986-50-9'),
        (3, 2, 'The Magician Apprentice', 'EN', '978-0-316-03788-4');
